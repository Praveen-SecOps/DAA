...
public class ex{
	...
	public static void main(String[] args) {
		Point P[] = {new Point(4,0), new Point(8,8), new Point(1,100),new Point(4,8),new Point(7,7) };
		closest(P);
        System.out.println();
        System.out.println();
		System.out.println("The nearest distance among the given points is ' "+bestDistance+" '");
		System.out.println();
        System.out.println();
	}
